...
//console.log(firstName, lastName, password, email, address, city, state, zip);
console.log("\n\nUSER CREATION ", reqData.queryString, reqData.payload);
    ...
    */
    static getContext(token, callback) {
        TokenHelper.getToken(token, (err, tokenData) => {
            console.log("UserContext.getToken", token, err, tokenData)
