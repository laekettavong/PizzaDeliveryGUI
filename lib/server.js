...
const server = {
    ...
    unifiedServer : (req, res) => {
        ...
        req.on('end', () => {
            ...
            //     console.log("Not JSON: ", contype);
            //     // buffer -> email=bar4%40gmail.com&password=tst&firstName=Lae&lastName=Kettavong&address=1234+Main+Street&city=Victor&state=NY&zip=14564
            //     //TODO convert buffer to JSON
           ...
           //console.log("Server Payload",  contype, trimmedPath);
